...
export declare class Transform {
    ...
    static uInt8ArrayToObject(payload: Uint8Array): object | string;
    /**
     * bufferToDate
     *
     * @static
     ...
     */
    static iteratorToList(iterator: Iterators.CommonIterator<any>): Promise<any[]>;
    /**
     * Transform iterator to array of objects
     *
     * @param {'fabric-shim'.Iterators.Iterator} iterator
     * @returns {Promise<Array>}
     */
    static iteratorToKVList(iterator: Iterators.CommonIterator<any>): Promise<KV[]>;
    /**
     * Transform iterator to array of objects
     *
